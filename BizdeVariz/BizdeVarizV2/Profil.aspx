...
<div class="profile-image-upload">
    ...
    <asp:LinkButton ID="lnkDosyaYukle" runat="server" CssClass="btn btn-primary" OnClientClick="document.getElementById('fileUploadProfilResmi').click(); return false;">
        Resim Yükle
    </asp:LinkButton>
    <!-- Dosya yükleme alanı -->
    <asp:FileUpload ID="fileUploadProfilResmi" runat="server" style="display: none;" onchange="document.getElementById('btnYukle').click();" />
    <!-- Dosya yükleme butonu (gizli) -->
    <asp:Button ID="btnYukle" runat="server" Text="Yükle" OnClick="btnYukle_Click" style="display: none;" />

        <asp:LinkButton ID="lnkCikisYap" runat="server" CssClass="btn btn-danger ml-2" OnClick="btnLogout_Click">Çıkış Yap</asp:LinkButton>
